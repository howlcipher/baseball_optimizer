...
def main():
    print("====================================================")
    print("STARTING BASEBALL OPTIMIZER API VERIFICATION SCRIPT")
    print("====================================================")
    ...
    # 1. Start the FastAPI server using uvicorn pointing to app.main:app
    print("Launching FastAPI server (app.main:app) on http://127.0.0.1:8080...")
    cmd = [sys.executable, "-m", "uvicorn", "app.main:app", "--host", "127.0.0.1", "--port", "8080", "--log-level", "warning"]
    ...
    for i in range(max_retries):
        if server_process.poll() is not None:
            print("ERROR: FastAPI server exited prematurely. Logs:")
    ...
    print("FastAPI server started and verified ready in background.")
